...
const cartonDos = document.getElementById('carton2')
const cartonTres = document.getElementById('carton3')
const fragmentUno = document.createDocumentFragment()
const fragmentDos = document.createDocumentFragment()
const fragmentTres = document.createDocumentFragment()
...
for(const numero of Numeros){
    ...
    cartonItem.textContent = numero
    cartonItem.setAttribute('value',numero)
    cartonItem.classList.add('btn', 'rounded-circle','cartonItem','bg-unselected' )
    fragmentDos.appendChild(cartonItem)
       
}

    cartonDos.appendChild(fragmentDos)
...
for(const numero of Numeros){
    ...
    cartonItem.setAttribute('value',numero)
    cartonItem.classList.add('btn', 'rounded-circle','cartonItem','bg-unselected')
    fragmentTres.appendChild(cartonItem)
       
}

    cartonTres.appendChild(fragmentTres)
